...
public class CoordinateTest {
    ...
    public void testGetDistanceComplex(){
        ...
        cc2=Math.sqrt(Math.pow(c1.getX(), 2) + Math.pow(c1.getY(), 2) + Math.pow(c1.getZ(), 2));
        cc3=Math.sqrt(Math.pow(c1.getX(), 2) + Math.pow(c1.getY(), 2) + Math.pow(c1.getZ(), 2));
        cc4=Math.sqrt(Math.pow(c1.getX(), 2) + Math.pow(c1.getY(), 2) + Math.pow(c1.getZ(), 2));
        cc5=Math.sqrt(Math.pow(c1.getX(), 2) + Math.pow(c1.getY(), 2) + Math.pow(c1.getZ(), 2));
        cc6=Math.sqrt(Math.pow(c1.getX(), 2) + Math.pow(c1.getY(), 2) + Math.pow(c1.getZ(), 2));
